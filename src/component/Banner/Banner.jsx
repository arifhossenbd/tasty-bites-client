      ...
      {loading ? (
        ...
        >
          ...
          <motion.div
            ...
            className="custom-prev absolute top-1/2 left-4 z-30 -translate-y-1/2 cursor-pointer bg-black/20 hover:bg-yellow-500 text-yellow-500 hover:text-yellow-50 btn rounded-none shadow-none border-none transition duration-300 text-lg md:text-2xl"
          >
            <FaArrowLeft />
          </motion.div>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6 }}
            className="custom-prev absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer bg-black/20 hover:bg-yellow-500 text-yellow-500 hover:text-yellow-50 btn rounded-none shadow-none border-none transition duration-300 text-lg md:text-2xl"
          >
            <FaArrowRight />
          </motion.div>
        </Swiper>
